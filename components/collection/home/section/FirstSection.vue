    ...
    <div class="relative isolate pt-14">
        ...
        <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-[2.99rem]">Customer Onboarding</h1>
            <p class="mt-6 text-[24px] font-bold leading-8 text-blue-700">
            ...
            <ul class="main_top_points">
              <li class="">
                <div class="flex items-baseline">
                  <div class="rounded-full bg-primary flex-shrink-0 mr-2">
                    <i class="fe fe-check"></i>
                  </div>
                  <p class="mb-0 w-[31rem]">
                    Create personalized and engaging popups for onboarding that is tailored to the customer
                  </p>
                </div>
              </li>
              <li class="">
                <div class="flex items-baseline">
                  ...
                  <p class="mb-0 w-[31rem]">
                    Create custom flows to guide your customers in their onboarding journey
                  </p>
                </div>
              </li>
              <li class="">
                <div class="flex items-baseline">
                  ...
                  <p class="mb-0 w-[31rem]">
                    Engage with popups, wizards and custom JS scripts based on the user's behavior
                  </p>
                </div>
              </li>
              <li class="">
                <div class="flex items-baseline">
                  ...
                  <p class="mb-0 w-[31rem]">
                    Integrate with NinjaChat, BotUp and Schedule.cc to deliver an interactive onboarding experience
                  </p>
                </div>
              </li>
              <li class="">
                <div class="flex items-baseline">
                  ...
                  <p class="mb-0 w-[31rem]">
                    Guide new users step‑by‑step to improve adoption and retention
                  </p>
                </div>
              </li>
            </ul>
