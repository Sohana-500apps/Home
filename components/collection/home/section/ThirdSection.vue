    ...
    <div class="relative isolate pt-14">
        ...
        <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            <h4 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-[2.99rem]">Flow Customization</h4>
            <p class="mt-6  leading-8 text-grey">
                Web page experiences that are personalized to the user and assist them in moving through the product usage will lead for faster learning
            </p>
            <h4 class="mt-10 max-w-lg text-[1.4rem] font-bold tracking-tight text-gray-900 sm:text-[2.99rem]">Low Coding Tool</h4>
            <p class="mt-6  leading-8 text-grey">
                You can create campaigns for onboarding through segmentation - Product wise, Department wise and Industry wise using low code development or programming
            </p>
            <h4 class="mt-10 max-w-lg text-[1.4rem] font-bold tracking-tight text-gray-900 sm:text-[2.99rem]">Wizard</h4>
            <p class="mt-6  leading-8 text-grey">
                A wizard helps in designing a tour that takes the user through well defined steps and completes all the necessary sections in the website
            </p>
